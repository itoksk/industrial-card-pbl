      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        ...
        >
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li className="text-zinc-900 dark:text-zinc-100 font-medium">カードデータリファレンス</li>
          </ol>
        </motion.nav>
                  ...
                  <div className="relative">
                    <div className="glass-card bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 border-2 border-red-300 dark:border-red-700 p-6 aspect-[2/3] flex flex-col">
                      ...
                      <div className="absolute top-4 right-4">
                        ...
                        <div className="absolute -right-2 -top-2 w-6 h-6 bg-yellow-400 rounded-full border-2 border-white dark:border-zinc-900 flex items-center justify-center">
                      ...
                      {/* Illustration Area */}
                      <div className="flex-1 bg-white dark:bg-zinc-800 rounded-lg flex items-center justify-center mb-4 border-2 border-dashed border-red-300 dark:border-red-700">
                      ...
                      <div className="space-y-2 mb-4">
                        <div className="flex items-center justify-between bg-white dark:bg-zinc-800 rounded px-3 py-2">
                          <span className="text-xs font-semibold text-zinc-600 dark:text-zinc-400">引火点</span>
                          <span className="text-sm font-bold text-red-600 dark:text-red-400">-40°C</span>
                        </div>
                        <div className="flex items-center justify-between bg-white dark:bg-zinc-800 rounded px-3 py-2">
                          <span className="text-xs font-semibold text-zinc-600 dark:text-zinc-400">発火点</span>
                          <span className="text-sm font-bold text-orange-600 dark:text-orange-400">300°C</span>
                        </div>
                        <div className="flex items-center justify-between bg-white dark:bg-zinc-800 rounded px-3 py-2">
                          <span className="text-xs font-semibold text-zinc-600 dark:text-zinc-400">攻撃力</span>
                          <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">95</span>
                        </div>
                      </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="glass-card bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-green-200 dark:border-green-800">
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="bg-white dark:bg-zinc-800 rounded p-2 flex justify-between">
                          <span className="font-mono text-zinc-700 dark:text-zinc-300">名称</span>
                          <span className="text-green-600 dark:text-green-400">携行缶</span>
                        </div>
                        <div className="bg-white dark:bg-zinc-800 rounded p-2 flex justify-between">
                          <span className="font-mono text-zinc-700 dark:text-zinc-300">容量</span>
                          <span className="text-green-600 dark:text-green-400">20L</span>
                        </div>
                        <div className="bg-white dark:bg-zinc-800 rounded p-2 flex justify-between">
                          <span className="font-mono text-zinc-700 dark:text-zinc-300">強化倍率</span>
                          <span className="text-green-600 dark:text-green-400">1.5</span>
                        </div>
                        <div className="bg-white dark:bg-zinc-800 rounded p-2 flex justify-between">
                          <span className="font-mono text-zinc-700 dark:text-zinc-300">効果</span>
                    ...
                    <div className="glass-card bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 border-purple-200 dark:border-purple-800">
                      ...
                      <div className="space-y-2 text-xs">
                        ...
                        <div className="bg-white dark:bg-zinc-800 rounded p-2 flex justify-between">
                          <span className="font-mono text-zinc-700 dark:text-zinc-300">対象</span>
                          <span className="text-purple-600 dark:text-purple-400">第3類</span>
                        </div>
                        <div className="bg-white dark:bg-zinc-800 rounded p-2 flex justify-between">
                          <span className="font-mono text-zinc-700 dark:text-zinc-300">ペナルティ</span>
                    ...
                    <div className="glass-card bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 border-indigo-200 dark:border-indigo-800">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h5 className="font-semibold text-zinc-900 dark:text-zinc-100 text-sm mb-1">
                              勝率の記録
                            </h5>
                            <p className="text-xs text-zinc-600 dark:text-zinc-400">
