                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="glass-card bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-950/30 dark:to-amber-950/30 border-yellow-200 dark:border-yellow-800">
                    ...
                    <div className="space-y-4">
                      <div className="bg-[var(--surface-glass)] rounded-lg p-4 border border-yellow-200 dark:border-yellow-800">
              ...
              <div className="space-y-8">
                <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 border-l-4 border-blue-500 rounded-lg p-6">
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    <div className="bg-[var(--surface-glass)] rounded-lg p-6 text-center border-2 border-indigo-200 dark:border-indigo-800">
                    ...
                    <div className="bg-[var(--surface-glass)] rounded-lg p-6 text-center border-2 border-blue-200 dark:border-blue-800">
                    ...
                    <div className="bg-[var(--surface-glass)] rounded-lg p-6 text-center border-2 border-green-200 dark:border-green-800">
                    ...
                    <div className="bg-[var(--surface-glass)] rounded-lg p-6 text-center border-2 border-purple-200 dark:border-purple-800">
                  ...
                  <div className="mt-6 flex items-center justify-center">
                    <div className="bg-[var(--surface-glass)] rounded-lg p-4 border-2 border-blue-300 dark:border-blue-700">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="glass-card bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 border-indigo-200 dark:border-indigo-800">
                    ...
                    <div className="space-y-3">
                      <div className="bg-[var(--surface-glass)] rounded-lg p-4 border border-indigo-200 dark:border-indigo-800">
                  ...
                  <div className="glass-card bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-950/30 dark:to-rose-950/30 border-pink-200 dark:border-pink-800">
                    ...
                    <div className="space-y-3">
                      <div className="bg-[var(--surface-glass)] rounded-lg p-4 border border-pink-200 dark:border-pink-800">
                        <h4 className="font-semibold text-[var(--text-primary)] mb-2 text-sm">
                          トーナメント大会
                        </h4>
                        <p className="text-xs text-[var(--text-muted)]">
